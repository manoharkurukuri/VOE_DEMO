"""Sales Specials extraction prompt.

This is the original prompt, moved verbatim from ``app/service/llm_extractor.py``.
Do not change its content: the Sales Specials behavior must remain identical.
"""
